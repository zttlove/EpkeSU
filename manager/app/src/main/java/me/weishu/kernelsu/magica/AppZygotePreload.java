...
public class AppZygotePreload implements ZygotePreload {
    ...
    private static native void forkDontCareAndExecKsud(String ksudPath, String packageName, int managerUid);
    ...
    public void doPreload(@NonNull ApplicationInfo appInfo) {
        ...
        try {
            ...
            forkDontCareAndExecKsud(f.getAbsolutePath(), appInfo.packageName, appInfo.uid);
        } catch (Throwable t) {
